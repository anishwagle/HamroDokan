...
namespace HamroDokan.Controllers
{
    ...
    public class StoreManagerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemId,CategoryId,Title,Price,ProducerId,ItemArtUrl")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemId,CategoryId,Title,Price,ProducerId,ItemArtUrl")] Item item)
        {
            if (ModelState.IsValid)
            {
